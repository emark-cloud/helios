...
function addressRows(addrs: HeliosAddresses): AddressRow[] {
  return [
    ...
    { label: "Strategy vault — momentum", value: addrs.strategyVaultMomentum },
    { label: "Strategy vault — mean reversion", value: addrs.strategyVaultMeanReversion },
    { label: "Strategy vault — yield rotation", value: addrs.strategyVaultYieldRotation },
