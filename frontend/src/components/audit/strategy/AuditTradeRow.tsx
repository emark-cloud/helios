    ...
    <>
      ...
      >
        <td className="px-3 py-3 align-top">
          ...
          <div className="font-mono text-[12px] text-fg-muted">{isoTs.slice(11, 19)}Z</div>
        </td>
        <td className="px-3 py-3 align-top">
        ...
        <td className="px-3 py-3 align-top">
          <code className="break-all font-mono text-[12px] text-fg-secondary">{trade.id}</code>
        </td>
          ...
          <td colSpan={7} className="px-4 py-4">
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <div>
                ...
                <dl className="mt-1.5 space-y-0.5 font-mono text-[12px] text-fg-secondary">
              ...
              <div className="flex flex-col items-start gap-3">
                ...
                <button
                  ...
                  className="rounded-sm border border-amber/40 px-3 py-1.5 font-mono text-[12px] uppercase tracking-[0.12em] text-amber hover:border-amber/80"
                >
                  Verify yourself →
                </button>
              </div>
...
function ShieldTreatment({ state }: { state: "valid" | "failed" }): JSX.Element {
  ...
  return (
    <div className="flex flex-col items-center gap-1" aria-label={label} title={label}>
      ...
      <span className={cn("font-mono text-[12px] uppercase tracking-[0.12em]", tone)}>
